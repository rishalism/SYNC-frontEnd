...
import { teamMemberGoogleSignup, teamMemberSignup } from '@/api/teamMemberApi';
...
function SingupModal({ openModal, setOpenModal }: any) {
                ...
                <Modal size={'sm'} show={openModal} >
                    <ModalBody>
                        <div className='flex flex-col space-y-5'>
                            <h2 className='font-semibold' >Signup as Team-Member to continue</h2>
                            <div>
                                ...
                                <svg width="300" height="200" viewBox="0 0 471 369" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex  flex-col mt-8">
                                <Button onClick={() => googleLogin()} variant={'outline'} className="border-2 gap-3 py-6 capitalize"><FcGoogle /> Sign Up with google </Button>
                                <span className='text-xs text-center mt-1'> ( take less than 1 min )</span>
                            </div>
                            <span className='text-xs text-center'>already have an Team-Member Account <span onClick={() => setOpenModal(false)} className='underline cursor-pointer' >Login</span></span>
                        </div>
                    </ModalBody>
                </Modal>
            </div>
